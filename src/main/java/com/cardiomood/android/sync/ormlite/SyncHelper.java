...
public class SyncHelper {
    ...
    public <E extends SyncEntity> void synObjects(final Class<E> entityClass, boolean userAware,
        ...
        try {
            ...
            final List<ParseObject> remoteObjects = ParseTools.findAllParseObjects(query, entityClass);
                    ...
                    for (ParseObject remoteObject : remoteObjects) {
                        ...
                        if (localObject == null) {
                            ...
                            if (localObject == null) {
                                ...
                                localObject = SyncEntity.fromParseObject(remoteObject, entityClass,dbHelper);
                            } else {
                                // the object exists locally but out-of-date
                                SyncEntity.fromParseObject(remoteObject, localObject,true,dbHelper);
                            }
                        ...
                        if (localObject != null) {
                            ...
                            if (remoteTime > localTime) {
                                ...
                                SyncEntity.toParseObject(localObject, remoteObject,true);
