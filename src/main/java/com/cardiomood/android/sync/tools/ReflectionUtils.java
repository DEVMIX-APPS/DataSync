...
public abstract class ReflectionUtils {
	 ...
	 */
	public static void doWithFields(Class<?> clazz, FieldCallback fc,ParseObject parseObject, SyncEntity object) throws IllegalArgumentException {
		doWithFields(clazz, fc, null, parseObject, object);
	}
	 ...
	 */
	public static void doWithFields(Class<?> clazz, FieldCallback fc, FieldFilter ff,ParseObject parseObject, SyncEntity object)
			throws IllegalArgumentException {
		...
		do {
			...
			for (Field field : fields) {
				...
				try {
					fc.doWith(field,parseObject,object);
				}
				catch (IllegalAccessException ex) {
	...
	public interface FieldCallback {
         ...
         * @param object
         */
		void doWith(Field field, ParseObject parseObject, SyncEntity object) throws IllegalArgumentException, IllegalAccessException;
	}
	...
	public static Object getMethodValue(String methodName,Class classe,Object object) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
		Method meth = classe.getMethod(methodName);
